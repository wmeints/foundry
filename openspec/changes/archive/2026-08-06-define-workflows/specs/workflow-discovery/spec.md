...
Workflow discovery provides the ability to automatically find, validate, and list TypeScript workflow definitions stored in the `.foundry/workflows` directory. Each workflow file follows a约定 format that exposes an Effect and a schedule.
